                    ...
                    <div class="col-6">
                        <div class="row row-cols-1">
                              <?php
                                ...
                                $lahan_parkir = select("SELECT nama, kode, kapasitas, jumlah_kosong, (kapasitas - jumlah_kosong) AS sisa FROM lahan_parkir ORDER BY sisa DESC");
                                ?>
                            <?php
                                foreach($lahan_parkir as $parkir) :
                                  $sisa = $parkir['kapasitas'] - $parkir['jumlah_kosong'];
                                  if ($sisa <= ($parkir['kapasitas'] * 0.25)) {
                                    ?>
                            ...
                            <?php
                                  } elseif($sisa <= ($parkir['kapasitas'] * 0.5)) {
                                    ?>
