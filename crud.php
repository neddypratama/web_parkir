          ...
          <div class="col-6">
            <div class="row row-cols-1">
              <div class="tambah-lahan col rounded-4 p-3 mb-2 d-flex text-center align-items-center justify-content-md-end">
                <a href="tambah.php">
                  <button class="btn btn-success rounded-start-pill p-2">
                ...
                <a href="login.php">
                  <button type="button" class="btn btn-danger p-2 rounded-end-pill text-light fw-semibold">
                    <span style="padding: 0px 4px;">Logout</span>
